...
const MembersCircles = (props) => {
  ...
  const remainingMembersNum =
    arrayMembers.length > 4 ? arrayMembers.length - 4 : "-";
  ...
  return (
    <>
      <div className="member-circles-container">
        ...
        {nameArray[2] !== "-" ?        <Tooltip placement="topLeft" title={fullNameArray[2]}>
          <div className="circle circle-three">{nameArray[2]}</div>
        </Tooltip> : null}
        {nameArray[3] !== "-" ?         <Tooltip placement="topLeft" title={fullNameArray[3]}>
          <div className="circle circle-four">{nameArray[3]}</div>
        </Tooltip> : null}
        {remainingMembersNum !== "-" ?         <Tooltip placement="topLeft" title={remainingMembersName.toString()}>
          <div className="circle circle-five">
            {remainingMembersNum === "-" ? "-" : "+" + remainingMembersNum}
          </div>
        </Tooltip> : null}
